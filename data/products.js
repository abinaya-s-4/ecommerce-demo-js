...
class Clothing extends Product{
  sizeChartLink;
  constructor(productDetails){
    super(productDetails); //inherit parent class
    this.sizeChartLink = "images/clothing-size-chart.png"
  }
  //Method overriding = override or replace the parent method for extraInfoHTML()
  extraInfoHTML(){
    return `
...
/*export let product =[];
 export function loadProducts(fun){
  ...
  });// transform array from objects to classes
